    ...
    <>
      ...
      <section
        style={{
          ...
          background: 'linear-gradient(160deg, #f5ede0 0%, #ede8f0 50%, #F2EFEA 100%)',
          position: 'relative',
          overflow: 'hidden',
        }}
      >
        ...
        <div className="wrap" style={{ position: 'relative', zIndex: 2, width: '100%' }}>
          ...
          >
            <span style={{ display: 'block', width: 40, height: 1, background: '#B09070', opacity: 0.6 }} />
        ...
        <div className="wrap">
          ...
          <div
            style={{
              ...
              maxWidth: 860,
              padding: '24px 28px',
              background: 'rgba(176,144,112,0.04)',
              border: '1px solid rgba(176,144,112,0.15)',
              borderRadius: 12,
              display: 'flex',
      ...
      <section
        style={{
          padding: 'clamp(80px,10vw,130px) clamp(24px,5vw,72px)',
          background: 'linear-gradient(160deg, #1e1628 0%, #2a1e3a 40%, #3d2d50 100%)',
          position: 'relative',
          overflow: 'hidden',
        }}
      >
        ...
        <div
          ...
          style={{
            ...
            inset: 0,
            background:
              'radial-gradient(ellipse 60% 60% at 80% 50%, rgba(176,144,112,0.12), transparent),' +
              'radial-gradient(ellipse 40% 40% at 20% 60%, rgba(123,107,158,0.18), transparent)',
            pointerEvents: 'none',
          }}
        />
        ...
        <div className="wrap" style={{ position: 'relative', zIndex: 2, maxWidth: 760 }}>
          ...
          >
            <span style={{ display: 'block', width: 40, height: 1, background: 'rgba(176,144,112,0.4)' }} />
            {declaration.titleEn}
          </p>
          <h2
            style={{
          ...
          <p
            style={{
              ...
              marginBottom: 56,
              maxWidth: 560,
              borderLeft: '2px solid rgba(176,144,112,0.3)',
              paddingLeft: 20,
              fontStyle: 'italic',
            }}
          >
          ...
          >
            <div
              style={{
                ...
                height: 44,
                borderRadius: '50%',
                border: '1px solid rgba(176,144,112,0.3)',
                background: 'rgba(176,144,112,0.08)',
                display: 'flex',
                alignItems: 'center',
