...
export default function ScPage() {
  ...
  return (
    <>
        ...
        <div style={{ maxWidth:1200, margin:'0 auto', padding:'0 8vw', position:'relative', zIndex:2 }}>
          ...
          <div className="md:hidden" style={{ position:'relative', paddingLeft:72, paddingRight:8, marginBottom:8, maxWidth:300, margin:'0 auto' }}>
            ...
            {([
              ...
              { id:'sc05', num:'05', label:'尋找內在小孩', en:'Inner Child',         img:'/sc/journey/內在小孩-color.png',              glow:'160,80,200', world:'靈魂碎片團員', worldColor:'#8844B8', imgFilter:'saturate(0.78) brightness(1.08) contrast(0.92)' },
              ...
              <a key={step.id} href={`#section-${step.id}`}
                ...
                <div style={{ textAlign:'center', flex:1, maxWidth:120 }}>
                  <p style={{ fontFamily:'var(--f-mono)', fontSize:12, letterSpacing:'0.2em', color:step.worldColor, opacity:0.7, marginBottom:4 }}>{step.num}</p>
                  {step.world && (
                  ...
                  <p style={{ fontSize:16, fontWeight:700, color:step.worldColor, letterSpacing:'0.04em', marginBottom:2 }}>{step.label}</p>
                  <p style={{ fontFamily:'var(--f-display)', fontSize:11, letterSpacing:'0.16em', color:step.worldColor, opacity:0.65, textTransform:'uppercase' }}>{step.en}</p>
                </div>
              </a>
            ))}
          </div>
          ...
          <div className="hidden md:block" style={{ width:'100%', marginBottom:8 }}>
            ...
            <div style={{ position:'relative', height:280, marginBottom:12 }}>
              ...
              <div style={{ position:'absolute', left:'calc(540/1100*100%)', bottom:0, transform:'translateX(-50%)', display:'flex', flexDirection:'column', alignItems:'center', gap:8, cursor:'pointer' }} onClick={() => selectNode('sc03')}>
                ...
                <div style={{ fontFamily:'var(--f-mono)', fontSize:13, letterSpacing:'0.2em', color:'#C05A30', opacity:0.7, marginBottom:2 }}>03</div>
                <div style={{ fontSize:18, fontWeight:700, color:'#C05A30', whiteSpace:'nowrap', letterSpacing:'0.04em' }}>脈輪情緒覺察</div>
                <div style={{ display:'inline-flex', alignItems:'center', padding:'2px 8px', borderRadius:2, background:'transparent', border:'1px solid #C05A30', fontFamily:'var(--f-mono)', fontSize:11, letterSpacing:'0.10em', color:'#C05A30', whiteSpace:'nowrap' }}>上部世界</div>
              </div>
              {/* 05 — 內在小孩, purple */}
              <div style={{ position:'absolute', left:'calc(1010/1100*100%)', bottom:0, transform:'translateX(-50%)', display:'flex', flexDirection:'column', alignItems:'center', gap:8, cursor:'pointer' }} onClick={() => selectNode('sc05')}>
                ...
                <div style={{ fontFamily:'var(--f-mono)', fontSize:13, letterSpacing:'0.2em', color:'#8844B8', opacity:0.7, marginBottom:2 }}>05</div>
                <div style={{ fontSize:18, fontWeight:700, color:'#8844B8', whiteSpace:'nowrap', letterSpacing:'0.04em' }}>尋找內在小孩</div>
                <div style={{ display:'inline-flex', alignItems:'center', padding:'2px 8px', borderRadius:2, background:'transparent', border:'1px solid #8844B8', fontFamily:'var(--f-mono)', fontSize:11, letterSpacing:'0.10em', color:'#8844B8', whiteSpace:'nowrap' }}>靈魂碎片團員</div>
              </div>
            </div>
      ...
      <section id="section-sc02" style={{ padding:'100px 0', background:'#E4EBF5', position:'relative', overflow:'hidden', minHeight:'100vh', display:'flex', flexDirection:'column', justifyContent:'center' }}>
        ...
        <div aria-hidden className="hidden md:block" style={{ position:'absolute', top:0, bottom:0, left:'50%', transform:'translateX(-50%)', width:'100%', maxWidth:1200, padding:'0 10vw', overflow:'hidden', pointerEvents:'none', zIndex:1 }}>
          <Image src="/sc/journey/指導靈-color.png" alt="" aria-hidden width={600} height={700}
            style={{ position:'absolute', left:'2%', top:'35%', height:'clamp(300px,60vh,500px)', width:'auto',
      ...
      {/* ═══ 帶領者 ═══ */}
      <section style={{ padding:'clamp(64px,9vh,100px) 0', background:'#233F52', position:'relative', overflow:'hidden' }}>
        <div aria-hidden style={{ position:'absolute', inset:0, background:'radial-gradient(ellipse 60% 50% at 50% 50%, rgba(94,142,138,0.14) 0%, transparent 70%)', pointerEvents:'none' }} />
        <div style={{ maxWidth:900, margin:'0 auto', padding:'0 clamp(24px,8vw,80px)', position:'relative', zIndex:2 }}>
          <p style={{ fontFamily:'var(--f-mono)', fontSize:'clamp(11px,1vw,12px)', letterSpacing:'0.38em', color:'rgba(140,185,210,0.65)', marginBottom:36, textTransform:'uppercase', borderTop:'1px solid rgba(180,210,230,0.15)', paddingTop:32 }}>
            Your Guides · 認識你的引路人
          </p>
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(300px,1fr))', gap:16 }}>
            {/* 禿禿 */}
            <div style={{ display:'flex', alignItems:'center', gap:20, padding:'22px 24px', border:'1px solid rgba(180,210,230,0.14)', borderRadius:10, background:'rgba(255,255,255,0.05)', textDecoration:'none' }}>
              <Image src="/index/吉祥物禿.png" alt="禿禿" width={60} height={60}
                style={{ width:60, height:60, objectFit:'contain', flexShrink:0, borderRadius:'50%', background:'rgba(94,142,138,0.15)' }} />
              <div>
                <span style={{ fontFamily:'var(--f-display)', fontWeight:700, fontSize:'clamp(14px,1.4vw,17px)', letterSpacing:'0.04em', color:'rgba(235,245,250,0.92)', display:'block', marginBottom:4 }}>禿禿 TWO TWO</span>
                <span style={{ fontFamily:'var(--f-mono)', fontSize:'clamp(10px,0.8vw,11px)', letterSpacing:'0.12em', color:'rgba(130,180,210,0.7)', display:'block', lineHeight:1.7 }}>頌缽 · 薩滿 · 能量定頻</span>
                <span style={{ fontSize:'clamp(12px,1vw,13px)', color:'rgba(195,220,235,0.6)', display:'block', marginTop:5, lineHeight:1.65 }}>身心狀態、潛意識定頻，以聲音引導感知回歸內在安定</span>
              </div>
            </div>
            {/* 夏 */}
            <div style={{ display:'flex', alignItems:'center', gap:20, padding:'22px 24px', border:'1px solid rgba(180,210,230,0.14)', borderRadius:10, background:'rgba(255,255,255,0.05)', textDecoration:'none' }}>
              <Image src="/index/吉祥物夏.png" alt="夏" width={60} height={60}
                style={{ width:60, height:60, objectFit:'contain', flexShrink:0, borderRadius:'50%', background:'rgba(94,142,138,0.15)' }} />
              <div>
                <span style={{ fontFamily:'var(--f-display)', fontWeight:700, fontSize:'clamp(14px,1.4vw,17px)', letterSpacing:'0.04em', color:'rgba(235,245,250,0.92)', display:'block', marginBottom:4 }}>夏</span>
                <span style={{ fontFamily:'var(--f-mono)', fontSize:'clamp(10px,0.8vw,11px)', letterSpacing:'0.12em', color:'rgba(130,180,210,0.7)', display:'block', lineHeight:1.7 }}>靈性顧問 · 易經 · 品牌策略</span>
                <span style={{ fontSize:'clamp(12px,1vw,13px)', color:'rgba(195,220,235,0.6)', display:'block', marginTop:5, lineHeight:1.65 }}>大方向定錨與理路梳理，結合玄天上帝指引與數位實務</span>
              </div>
            </div>
          </div>
        </div>
