...
// Version 1 — title on the LEFT
export default function WhatIsSection1() {
  return (
...
function WhyDifferentBlock() {
  return (
    ...
    >
      ...
      <p style={{ fontFamily: 'var(--f-display)', fontSize: 10, letterSpacing: '0.2em', color: 'rgba(255,255,255,0.4)', marginBottom: 10 }}>· 為什麼森波的頌缽不一樣 ·</p>
    ...
    <div>
      ...
      {brainwaves.map(bw => (
        <div key={bw.label} style={{ background: bw.bg, borderRadius: 2, padding: '20px 24px', marginBottom: 12, position: 'relative', overflow: 'hidden' }}>
          <p style={{ fontFamily: 'var(--f-display)', fontSize: 10, letterSpacing: '0.15em', color: '#65BAAF', marginBottom: 6 }}>{bw.label}</p>
